    ...
    <Card className="border-0 shadow-lg">
      <CardHeader className="p-4 sm:p-6">
        ...
        <CardDescription className="text-sm">
          Escolha para qual calendário sincronizar os seus turnos
        </CardDescription>
      </CardHeader>
        ...
        {!accessToken && (
          <Alert>
            <AlertDescription className="text-xs sm:text-sm">
              Inicie sessão para carregar calendários.
            </AlertDescription>
          </Alert>
        )}
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {selectedCalendarData.backgroundColor && (
                <div
                  ...
                  style={{
                    backgroundColor: selectedCalendarData.backgroundColor,
                  }}
                />
              )}
              <div className="min-w-0 flex-1">
                <p className="font-semibold text-xs sm:text-sm truncate">
                  {selectedCalendarData.summary}
                </p>
                <p className="text-xs text-muted-foreground">
                  {selectedCalendarData.primary
